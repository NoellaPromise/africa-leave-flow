    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="text-2xl font-bold text-purple-dark">IST Africa HR</div>
      ...
      <section className="container mx-auto px-6 py-16 text-center md:py-32">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600 dark:text-gray-300">
          Our comprehensive leave management system helps IST Africa optimize workforce planning, 
          track employee time off, and maintain operational efficiency.
        </p>
      </section>
